...
private fun CharacterArtwork(word: LessonWord?) {
    // KHÔNG đổ bóng ở đây (user 2026-09-20: "nền vuông trắng ở dưới ảnh", mọi level). Bóng cần
    // một mặt phẳng để nổi lên; ô này trong suốt nên Compose vẫn vẽ bóng quanh hình vuông bo góc
    // 120dp và mắt đọc ra một ô nền trắng sau ảnh. Ảnh vocab và emoji đều đã có nét riêng —
    // cùng lý do thẻ level bỏ ô nền hôm 09-18.
    Box(
